    ...
    public class InventoryAssist : IMenuAssist
    {
        ...
        private void HandleLeftGridRegion(DaggerfallInventoryWindow menuWindow, ControllerManager cm)
        {
            ...
            if (cm.Action1Pressed)
            {
                ...
                //editor.Toggle();
                //GameManager.Instance.PlayerEntity.Items.AddItem(ItemBuilder.CreateItem(ItemGroups.Jewellery, 133)); // Amulet 
                //GameManager.Instance.PlayerEntity.Items.AddItem(ItemBuilder.CreateItem(ItemGroups.Jewellery, 134)); // Bracers 
                //GameManager.Instance.PlayerEntity.Items.AddItem(ItemBuilder.CreateItem(ItemGroups.Jewellery, 135)); // Ring 
                //GameManager.Instance.PlayerEntity.Items.AddItem(ItemBuilder.CreateItem(ItemGroups.Jewellery, 136)); // Bracelet 
                //GameManager.Instance.PlayerEntity.Items.AddItem(ItemBuilder.CreateItem(ItemGroups.Jewellery, 137)); // Mark 
                //GameManager.Instance.PlayerEntity.Items.AddItem(ItemBuilder.CreateItem(ItemGroups.Gems, 3)); // Diamond 
                //GameManager.Instance.PlayerEntity.Items.AddItem(ItemBuilder.CreateItem(ItemGroups.Gems, 4)); // Jade
