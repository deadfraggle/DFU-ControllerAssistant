...
namespace gigantibyte.DFU.ControllerAssistant
{
    ...
    {
        private sealed class TavernRoomNumberpadHandler : IInputMessageBoxAssistHandler
        {
            ...
            {
                return owner.IsTavernRoomPopup(menuWindow);
            }
                ...
                if (cm.LegendPressed)
                {
                    owner.EnsureLegendUI(
                        ...
                        new List<LegendOverlay.LegendRow>()
                        {
                            ...
                            new LegendOverlay.LegendRow(cm.Action2Name, "Reset to 1"),
                        });
            ...
            private void BuildNumberpad(InputMessageBoxAssist owner, DaggerfallInputMessageBox menuWindow)
            {
                ...
                numberpadOverlay.SetMaxValue(350);
